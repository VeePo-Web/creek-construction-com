// Gallery image registry — the single source of truth for the captionless
// imagery used on /work (full wall) and the homepage strip. No titles,
// no locations, no project metadata — just images with descriptive alt.
...
export const GALLERY: GalleryImage[] = [
  ...
  { src: riverbendHero,           alt: "Backyard studio with curved cantilever roofline mid-construction." },
  ...
  { src: riverbendElevation,      alt: "Front elevation of a framed studio build with cedar privacy fence beyond." },
  ...
  { src: riverbendInterior,       alt: "Interior view through framed doorway showing OSB stud walls and tools." },
