    ...
    return (
      ...
      >
        ...
        <a
          ...
          className="inline-flex items-center gap-2 bg-cedar text-cedar-foreground px-5 py-3 rounded-[2px] cta-label hover:bg-cedar-hover transition-colors duration-300 min-h-[44px] tabular-nums"
        >
    ...
    >
      <div className={pad}>
        <div className="space-y-6">
          ...
          <Field label="Voucher or referral code (10% off)" htmlFor="qfi-voucher" optional>
            <input
              id="qfi-voucher"
              type="text"
              value={form.voucher}
      ...
      <div className="hairline">
        ...
        <div className="px-6 md:px-8 py-3">
          <button
            ...
            aria-label={ctaLabel}
            data-quote-cta
            className="w-full inline-flex items-center justify-center gap-2 bg-cedar text-cedar-foreground px-6 py-3.5 rounded-[2px] cta-label hover:bg-cedar-hover disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-300 min-h-[52px]"
          >
            {submitting ? (
              <>
