    ...
    >
      <DialogContent className="max-w-4xl w-[95vw] p-0 gap-0 overflow-hidden border-evergreen/20 bg-background sm:rounded-lg max-h-[92vh] grid-cols-1 md:grid-cols-[240px_1fr] md:grid">
        ...
        >
          <div className="relative z-10">
            <img
              ...
              loading="eager"
            />
            <p className="text-[10px] tracking-[0.22em] uppercase text-cedar/80 mb-3">
              Free · No obligation
            </p>
          ...
          <div className="relative z-10 mt-6 space-y-3 text-sm">
            ...
            <div className="flex items-center gap-2 text-cedar">
              ...
              <Star className="h-3 w-3 fill-cedar" aria-hidden />
              <Star className="h-3 w-3 fill-cedar" aria-hidden />
              <span className="text-[10px] tracking-[0.22em] uppercase text-evergreen-foreground/70 ml-1">
                Verified builds
              </span>
            </div>
            <a
        ...
        <div className="md:hidden bg-evergreen text-evergreen-foreground px-5 py-2.5 flex items-center gap-2.5">
          ...
          <span className="ml-auto text-[9px] tracking-[0.22em] uppercase text-cedar/80">
            Free Quote
          </span>
        </div>
          ...
          {success ? (
            ...
            <>
              ...
              <header className="px-6 md:px-8 pt-6 md:pt-7 pb-4">
                <p className="text-[10px] tracking-[0.22em] uppercase text-cedar mb-2">
              ...
              <div className="px-6 md:px-8 pb-6 flex-1 space-y-6">
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  <Field
                    ...
                    adornment={
                      phoneValid ? (
                        <span className="inline-flex items-center gap-1 text-[10px] tracking-[0.22em] uppercase text-cedar">
              ...
              >
                <div className="px-6 md:px-8 py-2 flex items-center justify-center gap-4 text-[10px] tracking-[0.22em] uppercase text-muted-foreground border-b border-border/30">
                ...
                <div className="px-6 md:px-8 py-3">
                  <button
                    ...
                    disabled={!canSubmit}
                    aria-label={ctaLabel}
                    className="w-full inline-flex items-center justify-center gap-2 bg-cedar text-cedar-foreground px-6 py-3.5 rounded-[2px] text-[12px] tracking-[0.22em] uppercase font-medium hover:bg-cedar-hover disabled:opacity-50 disabled:cursor-not-allowed transition-colors min-h-[52px]"
                  >
                    {submitting ? (
                      <>
